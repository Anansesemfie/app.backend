...
class EmailService {
    constructor() {
        ...
        this.logInfo = "";
        this.generateEmailTemplate = (body, header = "Hello", action) => `<html xmlns="http://www.w3.org/1999/xhtml">
<head>
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const msg = {
                    ...
                    text: options.text,
                    html: yield this.generateEmailTemplate(options.html, options.subject, action),
                };
